...
derive_from_dragonfly_template(
    wilson_animation_name="short_fertilize_pre",
    dragonfly_animation_name="idle",
    output_animation_name="short_fertilize_pre",
    dragonfly_animation_range=[0, 2],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="short_fertilize_lag",
    dragonfly_animation_name="idle",
    output_animation_name="short_fertilize_lag",
    dragonfly_animation_range=[2, 4],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="short_fertilize",
    dragonfly_animation_name="idle",
    output_animation_name="short_fertilize",
    dragonfly_animation_range=[4, None],
)

derive_from_dragonfly_template(
    wilson_animation_name="shortest_fertilize",
    dragonfly_animation_name="idle",
    output_animation_name="shortest_fertilize",
    dragonfly_animation_range=[4, None],
)
...
derive_from_dragonfly_template(
    wilson_animation_name="sing_pre",
    dragonfly_animation_name="idle",
    output_animation_name="sing_pre",
    dragonfly_animation_range=[0, 2],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="sing_lag",
    dragonfly_animation_name="idle",
    output_animation_name="sing_lag",
    dragonfly_animation_range=[4, None],
)

derive_from_dragonfly_template(
    wilson_animation_name="sing",
    dragonfly_animation_name="idle",
    output_animation_name="sing",
    dragonfly_animation_range=[4, None],
)

derive_from_dragonfly_template(
    wilson_animation_name="sing_fail",
    dragonfly_animation_name="idle",
    output_animation_name="sing_fail",
    dragonfly_animation_range=[4, None],
)
...
derive_from_dragonfly_template(
    wilson_animation_name="slingshot_alt_pre_downside",
    dragonfly_animation_name="idle",
    output_animation_name="slingshot_alt_pre_downside",
    dragonfly_animation_range=[0, 2],
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="slingshot_pre_downside",
    dragonfly_animation_name="idle",
    output_animation_name="slingshot_pre_downside",
    dragonfly_animation_range=[0, 2],
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="slingshot_downside",
    dragonfly_animation_name="idle",
    output_animation_name="slingshot_downside",
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="slingshot_lag_downside",
    dragonfly_animation_name="idle",
    output_animation_name="slingshot_lag_downside",
...
derive_from_dragonfly_template(
    wilson_animation_name="spider_repellent",
    dragonfly_animation_name="idle",
    output_animation_name="spider_repellent",
)

# ================= staff

derive_from_dragonfly_template(
    wilson_animation_name="staff_pre",
    dragonfly_animation_name="idle",
    output_animation_name="staff_pre",
    dragonfly_animation_range=[0, 7],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="staff_lag",
    dragonfly_animation_name="idle",
    output_animation_name="staff_lag",
    dragonfly_animation_range=[7, 9],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="staff",
    dragonfly_animation_name="idle",
    output_animation_name="staff",
...
derive_from_dragonfly_template(
    wilson_animation_name="strum_pre",
    dragonfly_animation_name="idle",
    output_animation_name="strum_pre",
    dragonfly_animation_range=[0, 6],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="strum_lag",
    dragonfly_animation_name="idle",
    output_animation_name="strum_lag",
    dragonfly_animation_range=[6, 8],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="strum",
    dragonfly_animation_name="idle",
    output_animation_name="strum",
...
derive_from_dragonfly_template(
    wilson_animation_name="throw_pre",
    dragonfly_animation_name="idle",
    output_animation_name="throw_pre",
    dragonfly_animation_range=[0, 6],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="throw_lag",
    dragonfly_animation_name="idle",
    output_animation_name="throw_lag",
    dragonfly_animation_range=[6, 8],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="throw",
    dragonfly_animation_name="idle",
    output_animation_name="throw",
    dragonfly_animation_range=[8, None],
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_empty_pre",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_empty_pre",
    dragonfly_animation_range=[0, 7],
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_empty_lag",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_empty_lag",
    dragonfly_animation_range=[7, 9],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="tophat_empty_start",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_empty_start",
    dragonfly_animation_range=[9, 21],
    animation_length_align=2,
)


derive_from_dragonfly_template(
    wilson_animation_name="tophat_empty_pst",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_empty_pst",
    dragonfly_animation_range=[21, None],
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_equipped_pre",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_equipped_pre",
    dragonfly_animation_range=[0, 7],
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_equipped_lag",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_equipped_lag",
    dragonfly_animation_range=[7, 9],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="tophat_equipped_start",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_equipped_start",
    dragonfly_animation_range=[9, 21],
    animation_length_align=2,
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_equipped_pst",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_equipped_pst",
    dragonfly_animation_range=[21, None],
)
...
derive_from_dragonfly_template(
    wilson_animation_name="tophat_item_in",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_item_in",
    dragonfly_animation_range=[0, 2],
    animation_length_align=2,
)

derive_from_dragonfly_template(
    wilson_animation_name="tophat_loop",
    dragonfly_animation_name="idle",
    output_animation_name="tophat_loop",
)
