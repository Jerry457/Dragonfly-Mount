...
WILSON_ANIMATION_NAME = "emote_loop_toast"
DRAGONFLY_ANIMATION_NAME = "emote_loop_toast"

OUTPUT_ANIMATION_NAME = "emote_loop_toast"
...
dragonfly_anim = load_anim("assets/emote_toast.json")
...
dragonfly_idle = apply_follow_symbol(
    ...
    params={
        ...
        "local_scale_x": -LOCAL_SCALE_X * mult,
        "local_scale_y": LOCAL_SCALE_Y * mult,
        "local_rotate": 0,
        "z_index_offset": -1,
        "inherit_pos_x": True,
        "inherit_pos_y": True,
