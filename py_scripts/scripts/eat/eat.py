...
WILSON_ANIMATION_NAME = "eat"
DRAGONFLY_ANIMATION_NAME = "idle"

OUTPUT_ANIMATION_NAME = "eat"
...
dragonfly_idle_old = deepcopy(dragonfly_idle)

dragonfly_idle["frames"] = dragonfly_idle["frames"][8:]

dragonfly_idle = joint_animations(
    [dragonfly_idle, dragonfly_idle_old], DRAGONFLY_ANIMATION_NAME
)
