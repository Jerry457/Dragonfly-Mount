...
local function GrowTime()
    return TUNING.DRAGONFLY_MOUNT_GROW_DAYS * TUNING.TOTAL_DAY_TIME
    -- return 5
end
...
local DRAGONFLY_DAMAGE = 150 * TUNING.DRAGONFLY_MOUNT_DAMAGE_MULT
local DRAGONFLY_ATTACK_RANGE = 5
local DRAGONFLY_HIT_RANGE = 6
local DRAGONFLY_HEALTH = 5500 * TUNING.DRAGONFLY_MOUNT_HEALTH_MULT
...
local function DoRecallDespawn(inst)
...
local function fn()
    ...
    inst.components.eater:SetAbsorptionModifiers(4,2,1)
    ...
    inst.DoRecallDespawn = DoRecallDespawn
